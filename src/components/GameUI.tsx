    ...
    <div className="absolute inset-0 pointer-events-none flex flex-col items-stretch justify-between p-10 font-[Inter]">
        ...
        <AnimatePresence>
          ...
          {gameState === 'BOSS_WARNING' && (
            ...
            >
              ...
              <h2 className="text-6xl font-black uppercase italic text-rose-600 drop-shadow-[0_0_20px_rgba(255,16,240,0.8)]">
                ANOMALY <br /> DETECTED
              </h2>
            </motion.div>
          )}
      ...
      <div className="w-full flex justify-between items-end pointer-events-auto z-20">
        ...
        <div className="flex flex-col items-end">
          <div className="text-[10px] uppercase tracking-[0.2em] text-white/50 mb-3">PRIDE OVERDRIVE</div>
          <div className="flex gap-4 items-center">
            <div className="text-[9px] text-white/30 uppercase tracking-widest font-mono">BOMB READY</div>
            <div className="w-[180px] h-3 bg-white/10 rounded-full overflow-hidden border border-white/10">
              <motion.div 
                initial={{ width: 0 }}
                animate={{ width: `${Math.min(100, (score % 5000) / 50)}%` }}
